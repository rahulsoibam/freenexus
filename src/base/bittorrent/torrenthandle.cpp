...
// 2. https://github.com/freenexus/freeNexus/issues/6406
...
{
    // additional info: https://github.com/freenexus/freeNexus/pull/5300#issuecomment-267783646
...
void TorrentHandle::handleSaveResumeDataAlert(libtorrent::save_resume_data_alert *p)
{
    ...
    if (useDummyResumeData) {
        ...
        // restored if freeNexus quits before the metadata are retrieved:
...
void TorrentHandle::handleSaveResumeDataFailedAlert(libtorrent::save_resume_data_failed_alert *p)
{
    ...
    // containing Magnet URI and freeNexus own resume data only
