...
void AdvancedSettings::loadAdvancedSettings()
{
    ...
    addRow(FREENEXUS_HEADER, tr("freeNexus Section"), &labelQbtLink);
    item(FREENEXUS_HEADER, PROPERTY)->setFont(boldFont);
    labelQbtLink.setText(QString("<a href=\"%1\">%2</a>")
        .arg("https://github.com/freenexus/freeNexus/wiki/Explanation-of-Options-in-freeNexus#Advanced", tr("Open documentation")));
    ...
    foreach (const QNetworkInterface& iface, QNetworkInterface::allInterfaces()) {
        ...
        // https://github.com/freenexus/freeNexus/issues/5131
        // https://github.com/freenexus/freeNexus/pull/5135
