    ...
    , m_hasPython(false)
{
    ...
    setWindowTitle("freeNexus " QBT_VERSION);
    m_displaySpeedInTitle = pref->speedInTitleBar();
    // Setting icons
#ifndef Q_OS_MAC
#ifdef Q_OS_UNIX
    if (Preferences::instance()->useSystemIconTheme())
        setWindowIcon(QIcon::fromTheme("freenexus", QIcon(":/icons/skin/freenexus32.png")));
    else
#endif // Q_OS_UNIX
    setWindowIcon(QIcon(":/icons/skin/freenexus32.png"));
#endif // Q_OS_MAC
    ...
    if (!pref->neverCheckFileAssoc() && (!Preferences::isTorrentFileAssocSet() || !Preferences::isMagnetLinkAssocSet())) {
        if (QMessageBox::question(this, tr("Torrent file association"),
                                  tr("freeNexus is not the default application to open torrent files or Magnet links.\nDo you want to associate freeNexus to torrent files and Magnet links?"),
...
{
    QDesktopServices::openUrl(QUrl("http://doc.freenexus.org"));
}
...
void MainWindow::notifyOfUpdate(QString)
{
    ...
    Logger::instance()->addMessage(tr("freeNexus was just updated and needs to be restarted for the changes to be effective.")
                                   , Log::CRITICAL);
...
void MainWindow::closeEvent(QCloseEvent *e)
{
    ...
    if (pref->confirmOnExit() && BitTorrent::Session::instance()->hasActiveTorrents()) {
        if (e->spontaneous() || m_forceExit) {
            if (!isVisible())
                show();
            QMessageBox confirmBox(QMessageBox::Question, tr("Exiting freeNexus"),
                                   // Split it because the last sentence is used in the Web UI
                                   tr("Some files are currently transferring.") + "\n" + tr("Are you sure you want to quit freeNexus?"),
...
void MainWindow::updateGUI()
{
    ...
    if (m_displaySpeedInTitle) {
        setWindowTitle(tr("[D: %1, U: %2] freeNexus %3", "D = Download; U = Upload; %3 is freeNexus version")
...
void MainWindow::showNotificationBaloon(QString title, QString msg) const
{
    ...
    QVariantMap hints;
    hints["desktop-entry"] = "freeNexus";
    QDBusPendingReply<uint> reply = notifications.Notify("freeNexus", 0, "freenexus", title,
...
void MainWindow::handleUpdateCheckFinished(bool updateAvailable, QString newVersion, bool invokedByUser)
{
    ...
    if (updateAvailable) {
        answer = QMessageBox::question(this, tr("freeNexus Update Available"),
        ...
        QMessageBox::information(this, tr("Already Using the Latest freeNexus Version"),
...
{
    QDesktopServices::openUrl(QUrl("https://www.freenexus.org/donate"));
}
...
QIcon MainWindow::getSystrayIcon() const
{
    ...
    case TrayIcon::NORMAL:
        return QIcon::fromTheme(QLatin1String("freenexus-tray"));
    case TrayIcon::MONO_DARK:
        return QIcon::fromTheme(QLatin1String("freenexus-tray-dark"));
    case TrayIcon::MONO_LIGHT:
        return QIcon::fromTheme(QLatin1String("freenexus-tray-light"));
    default:
        break;
    }
#else
    switch (style) {
    case TrayIcon::NORMAL:
        return QIcon(QLatin1String(":/icons/skin/freenexus-tray.svg"));
    case TrayIcon::MONO_DARK:
        return QIcon(QLatin1String(":/icons/skin/freenexus-tray-dark.svg"));
    case TrayIcon::MONO_LIGHT:
        return QIcon(QLatin1String(":/icons/skin/freenexus-tray-light.svg"));
    default:
        break;
    }
#endif
