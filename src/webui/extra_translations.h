...
static const char *__TRANSLATIONS__[] = {
    ...
    QT_TRANSLATE_NOOP("HttpServer", "Exit freeNexus"),
    ...
    QT_TRANSLATE_NOOP("HttpServer", "Unable to save program preferences, freeNexus is probably unreachable."),
    ...
    QT_TRANSLATE_NOOP("HttpServer", "freeNexus client is not reachable"),
    QT_TRANSLATE_NOOP("HttpServer", "freeNexus has been shutdown."),
    QT_TRANSLATE_NOOP("HttpServer", "Unable to log in, freeNexus is probably unreachable."),
    ...
    QT_TRANSLATE_NOOP("HttpServer", "IRC: #freenexus on Freenode"),
