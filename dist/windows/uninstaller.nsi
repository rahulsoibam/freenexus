...
; Remove files and uninstaller
  Delete "$INSTDIR\freenexus.exe"
  Delete "$INSTDIR\freenexus.pdb"
...
Section "un.$(remove_associations)" ;"un.Remove file associations"
  ...
  StrCmp $0 '"$INSTDIR\freenexus.exe" "%1"' 0 magnet_end
...
Section "un.$(remove_registry)" ;"un.Remove registry keys"
  ...
  DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\freeNexus"
  DeleteRegKey HKLM "Software\freeNexus"
  DeleteRegKey HKLM "Software\Classes\freeNexus"
...
Section "un.$(remove_firewall)" ;
  ...
  nsisFirewallW::RemoveAuthorizedApplication "$INSTDIR\freenexus.exe"
