...
;Uncomment when packaging 64bit freenexus
;!define APP64BIT
...
!ifndef APP64BIT
  ...
  Name "freeNexus ${PROG_VERSION}"

  ; The file to write
  OutFile "freenexus_${PROG_VERSION}_setup.exe"
!else
  ; The name of the installer
  Name "freeNexus ${PROG_VERSION} x64"

  ; The file to write
  OutFile "freenexus_${PROG_VERSION}_x64_setup.exe"
!endif

;Installer Version Information
VIAddVersionKey "ProductName" "freeNexus"
VIAddVersionKey "CompanyName" "The freeNexus project"
VIAddVersionKey "LegalCopyright" "Copyright ©2006-2018 The freeNexus project"
VIAddVersionKey "FileDescription" "freeNexus - A Bittorrent Client"
...
!ifndef APP64BIT
  InstallDir $PROGRAMFILES32\freeNexus
!else
  InstallDir $PROGRAMFILES64\freeNexus
!endif

; Registry key to check for directory (so if you install again, it will 
; overwrite the old one automatically)
InstallDirRegKey HKLM Software\freenexus InstallLocation
...
!define MUI_LANGDLL_REGISTRY_KEY "Software\freenexus" 
