...
LangString inst_qbt_req ${LANG_AFRIKAANS} "freeNexus (required)"
...
LangString inst_torrent ${LANG_AFRIKAANS} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_AFRIKAANS} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_AFRIKAANS} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_AFRIKAANS} "Launch freeNexus."
...
LangString uninst_warning ${LANG_AFRIKAANS} "freeNexus is running. Please close the application before uninstalling."
