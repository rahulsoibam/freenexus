...
LangString inst_qbt_req ${LANG_CROATIAN} "freeNexus (neophodno)"
...
LangString inst_torrent ${LANG_CROATIAN} "Otvori .torrent datoteke s freeNexusom"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_CROATIAN} "Otvori magnet linkove s freeNexusom"
...
LangString inst_warning ${LANG_CROATIAN} "freeNexus je pokrenut. Zatvorite ga prije instalacije."
...
LangString launch_qbt ${LANG_CROATIAN} "Pokreni freeNexus."
...
LangString uninst_warning ${LANG_CROATIAN} "freeNexus je pokrenut. Zatvorite ga prije deinstalacije."
