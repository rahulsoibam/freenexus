...
LangString inst_qbt_req ${LANG_TRADCHINESE} "freeNexus (必要)"
...
LangString inst_torrent ${LANG_TRADCHINESE} "使用 freeNexus 開啟 .torrent 檔案"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_TRADCHINESE} "使用 freeNexus 開啟 magnet 連結"
...
LangString inst_warning ${LANG_TRADCHINESE} "freeNexus 正在執行中，請先關閉後再進行安裝。"
...
LangString launch_qbt ${LANG_TRADCHINESE} "啟動 freeNexus"
...
LangString uninst_warning ${LANG_TRADCHINESE} "freeNexus 正在執行中，請先關閉後再進行移除。"
