...
LangString inst_qbt_req ${LANG_THAI} "freeNexus (required)"
...
LangString inst_torrent ${LANG_THAI} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_THAI} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_THAI} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_THAI} "Launch freeNexus."
...
LangString uninst_warning ${LANG_THAI} "freeNexus is running. Please close the application before uninstalling."
