...
LangString inst_qbt_req ${LANG_LITHUANIAN} "freeNexus (reikalingas)"
...
LangString inst_torrent ${LANG_LITHUANIAN} "Atidaryti .torrent failus su freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_LITHUANIAN} "Atidaryti magneto nuorodas su freeNexus"
...
LangString inst_warning ${LANG_LITHUANIAN} "freeNexus yra paleistas. Prašau uždaryti programą prieš įdiegiant."
...
LangString launch_qbt ${LANG_LITHUANIAN} "Paleisti freeNexus."
...
LangString uninst_warning ${LANG_LITHUANIAN} "freeNexus yra paleistas. Prašau uždarykite programą prieš išdiegiant."
