...
LangString inst_qbt_req ${LANG_DUTCH} "freeNexus (required)"
...
LangString inst_torrent ${LANG_DUTCH} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_DUTCH} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_DUTCH} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_DUTCH} "Launch freeNexus."
...
LangString uninst_warning ${LANG_DUTCH} "freeNexus is running. Please close the application before uninstalling."
