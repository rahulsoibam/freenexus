...
LangString inst_qbt_req ${LANG_KOREAN} "freeNexus (required)"
...
LangString inst_torrent ${LANG_KOREAN} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_KOREAN} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_KOREAN} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_KOREAN} "Launch freeNexus."
...
LangString uninst_warning ${LANG_KOREAN} "freeNexus is running. Please close the application before uninstalling."
