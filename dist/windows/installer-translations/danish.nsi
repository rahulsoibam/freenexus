...
LangString inst_qbt_req ${LANG_DANISH} "freeNexus (påkrævet)"
...
LangString inst_torrent ${LANG_DANISH} "Åbn .torrent-filer med freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_DANISH} "Åbn magnet-links med freeNexus"
...
LangString inst_warning ${LANG_DANISH} "freeNexus kører. Luk venligst programmet inden installation."
...
LangString launch_qbt ${LANG_DANISH} "Start freeNexus."
...
LangString uninst_warning ${LANG_DANISH} "freeNexus kører. Luk venligst programmet inden afinstallation."
