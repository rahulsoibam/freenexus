...
;LangString inst_qbt_req ${LANG_ENGLISH} "freeNexus (required)"
LangString inst_qbt_req ${LANG_UKRAINIAN} "freeNexus (необхідний)"
...
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with freeNexus"
LangString inst_torrent ${LANG_UKRAINIAN} "Відкривати .torrent файли за допомогою freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_UKRAINIAN} "Відкривати посилання magnet за допомогою freeNexus"
...
;LangString inst_warning ${LANG_ENGLISH} "freeNexus is running. Please close the application before installing."
LangString inst_warning ${LANG_UKRAINIAN} "freeNexus вже виконується. Будь ласка, закрийте застосунок перед запуском інсталятору."
...
;LangString launch_qbt ${LANG_ENGLISH} "Launch freeNexus."
LangString launch_qbt ${LANG_UKRAINIAN} "Запустити freeNexus."
...
;LangString uninst_warning ${LANG_ENGLISH} "freeNexus is running. Please close the application before uninstalling."
LangString uninst_warning ${LANG_UKRAINIAN} "freeNexus виконується. Будь ласка, закрийте застосунок перед деінсталляцією."
