...
LangString inst_qbt_req ${LANG_PORTUGUESE} "freeNexus (obrigatório)"
...
LangString inst_torrent ${LANG_PORTUGUESE} "Abrir ficheiros .torrent com o freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_PORTUGUESE} "Abrir ligações magnet com o freeNexus"
...
LangString inst_warning ${LANG_PORTUGUESE} "O freeNexus está a ser executado. Feche a aplicação antes de instalar esta versão."
...
LangString launch_qbt ${LANG_PORTUGUESE} "Iniciar freeNexus."
...
LangString uninst_warning ${LANG_PORTUGUESE} "O freeNexus está a ser executado. Feche a aplicação antes de desinstalar esta versão."
