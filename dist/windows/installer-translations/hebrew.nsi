...
LangString inst_qbt_req ${LANG_HEBREW} "freeNexus (required)"
...
LangString inst_torrent ${LANG_HEBREW} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_HEBREW} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_HEBREW} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_HEBREW} "Launch freeNexus."
...
LangString uninst_warning ${LANG_HEBREW} "freeNexus is running. Please close the application before uninstalling."
