...
LangString inst_qbt_req ${LANG_TURKISH} "freeNexus (zorunlu)"
...
LangString inst_torrent ${LANG_TURKISH} ".torrent dosyalarını freeNexus ile aç"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_TURKISH} "Magnet bağlantılarını freeNexus ile aç"
...
LangString inst_warning ${LANG_TURKISH} "freeNexus çalışıyor. Lütfen yüklemeden önce uygulamayı kapatın."
...
LangString launch_qbt ${LANG_TURKISH} "freeNexus'i çalıştır."
...
LangString uninst_warning ${LANG_TURKISH} "freeNexus çalışıyor. Lütfen kaldırmadan önce uygulamayı kapatın."
