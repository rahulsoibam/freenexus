...
LangString inst_qbt_req ${LANG_MALAY} "freeNexus (required)"
...
LangString inst_torrent ${LANG_MALAY} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_MALAY} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_MALAY} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_MALAY} "Launch freeNexus."
...
LangString uninst_warning ${LANG_MALAY} "freeNexus is running. Please close the application before uninstalling."
