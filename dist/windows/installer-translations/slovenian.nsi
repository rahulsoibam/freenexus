...
LangString inst_qbt_req ${LANG_SLOVENIAN} "freeNexus (required)"
...
LangString inst_torrent ${LANG_SLOVENIAN} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_SLOVENIAN} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_SLOVENIAN} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_SLOVENIAN} "Launch freeNexus."
...
LangString uninst_warning ${LANG_SLOVENIAN} "freeNexus is running. Please close the application before uninstalling."
