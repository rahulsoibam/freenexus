...
LangString inst_qbt_req ${LANG_IRISH} "freeNexus (required)"
...
LangString inst_torrent ${LANG_IRISH} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_IRISH} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_IRISH} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_IRISH} "Launch freeNexus."
...
LangString uninst_warning ${LANG_IRISH} "freeNexus is running. Please close the application before uninstalling."
