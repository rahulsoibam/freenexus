...
LangString inst_qbt_req ${LANG_ARABIC} "freeNexus (مطلوب)"
...
LangString inst_torrent ${LANG_ARABIC} "فتح ملفات التورنت باستخدام freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_ARABIC} "فتح الروابط المغناطيسية باستخدام freeNexus"
