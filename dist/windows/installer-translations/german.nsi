...
LangString inst_qbt_req ${LANG_GERMAN} "freeNexus (erforderlich)"
...
LangString inst_torrent ${LANG_GERMAN} "Öffne .torrent-Dateien mit freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_GERMAN} "Öffne Magnet-Links mit freeNexus"
...
LangString inst_warning ${LANG_GERMAN} "freeNexus läuft gerade. Bitte das Programm vor der Installation beenden."
...
LangString launch_qbt ${LANG_GERMAN} "Starte freeNexus."
...
LangString uninst_warning ${LANG_GERMAN} "freeNexus läuft gerade. Bitte das Programm vor der Deinstallation beenden."
