...
LangString inst_qbt_req ${LANG_SLOVAK} "freeNexus (required)"
...
LangString inst_torrent ${LANG_SLOVAK} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_SLOVAK} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_SLOVAK} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_SLOVAK} "Launch freeNexus."
...
LangString uninst_warning ${LANG_SLOVAK} "freeNexus is running. Please close the application before uninstalling."
