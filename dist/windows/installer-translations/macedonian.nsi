...
LangString inst_qbt_req ${LANG_MACEDONIAN} "freeNexus (required)"
...
LangString inst_torrent ${LANG_MACEDONIAN} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_MACEDONIAN} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_MACEDONIAN} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_MACEDONIAN} "Launch freeNexus."
...
LangString uninst_warning ${LANG_MACEDONIAN} "freeNexus is running. Please close the application before uninstalling."
