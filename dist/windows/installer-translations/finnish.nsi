...
LangString inst_qbt_req ${LANG_FINNISH} "freeNexus (required)"
...
LangString inst_torrent ${LANG_FINNISH} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_FINNISH} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_FINNISH} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_FINNISH} "Launch freeNexus."
...
LangString uninst_warning ${LANG_FINNISH} "freeNexus is running. Please close the application before uninstalling."
