...
LangString inst_qbt_req ${LANG_PORTUGUESEBR} "freeNexus (requerido)"
...
LangString inst_torrent ${LANG_PORTUGUESEBR} "Abrir arquivos .torrent com freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_PORTUGUESEBR} "Abrir links magnéticos com freeNexus"
...
LangString inst_warning ${LANG_PORTUGUESEBR} "freeNexus está rodando. Por favor feche a aplicação antes de instalar."
...
LangString launch_qbt ${LANG_PORTUGUESEBR} "Executar freeNexus."
...
LangString uninst_warning ${LANG_PORTUGUESEBR} "freeNexus está rodando. Por favor feche a aplicação antes de desinstalar."
