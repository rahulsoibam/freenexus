...
LangString inst_qbt_req ${LANG_ROMANIAN} "freeNexus (required)"
...
LangString inst_torrent ${LANG_ROMANIAN} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_ROMANIAN} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_ROMANIAN} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_ROMANIAN} "Launch freeNexus."
...
LangString uninst_warning ${LANG_ROMANIAN} "freeNexus is running. Please close the application before uninstalling."
