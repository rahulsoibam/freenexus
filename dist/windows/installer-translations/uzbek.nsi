...
LangString inst_qbt_req ${LANG_UZBEK} "freeNexus (required)"
...
LangString inst_torrent ${LANG_UZBEK} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_UZBEK} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_UZBEK} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_UZBEK} "Launch freeNexus."
...
LangString uninst_warning ${LANG_UZBEK} "freeNexus is running. Please close the application before uninstalling."
