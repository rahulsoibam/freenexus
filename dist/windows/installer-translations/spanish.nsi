...
LangString inst_qbt_req ${LANG_SPANISH} "freeNexus (necesario)"
...
LangString inst_torrent ${LANG_SPANISH} "Abrir archivos .torrent con freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_SPANISH} "Abrir enlaces magnet con freeNexus"
...
LangString inst_warning ${LANG_SPANISH} "freeNexus se está ejecutando. Ciérrelo antes de continuar."
...
LangString launch_qbt ${LANG_SPANISH} "Iniciar freeNexus."
...
LangString uninst_warning ${LANG_SPANISH} "freeNexus se está ejecutando. Ciérrelo antes de continuar."
