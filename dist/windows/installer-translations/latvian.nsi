...
LangString inst_qbt_req ${LANG_LATVIAN} "freeNexus (required)"
...
LangString inst_torrent ${LANG_LATVIAN} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_LATVIAN} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_LATVIAN} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_LATVIAN} "Launch freeNexus."
...
LangString uninst_warning ${LANG_LATVIAN} "freeNexus is running. Please close the application before uninstalling."
