...
LangString inst_qbt_req ${LANG_SIMPCHINESE} "freeNexus (必要)"
...
LangString inst_torrent ${LANG_SIMPCHINESE} "用 freeNexus 打开.torrent文件"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_SIMPCHINESE} "用 freeNexus 打开磁力链接"
...
LangString inst_warning ${LANG_SIMPCHINESE} "freeNexus 正在运行。 安装前请关闭应用程序。"
...
LangString launch_qbt ${LANG_SIMPCHINESE} "启动 freeNexus."
...
LangString uninst_warning ${LANG_SIMPCHINESE} "freeNexus 正在运行。 卸载前请关闭程序。"
