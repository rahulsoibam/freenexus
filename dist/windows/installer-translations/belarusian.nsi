...
LangString inst_qbt_req ${LANG_BELARUSIAN} "freeNexus (required)"
...
LangString inst_torrent ${LANG_BELARUSIAN} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_BELARUSIAN} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_BELARUSIAN} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_BELARUSIAN} "Launch freeNexus."
...
LangString uninst_warning ${LANG_BELARUSIAN} "freeNexus is running. Please close the application before uninstalling."
