...
LangString inst_qbt_req ${LANG_SERBIAN} "freeNexus (required)"
...
LangString inst_torrent ${LANG_SERBIAN} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_SERBIAN} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_SERBIAN} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_SERBIAN} "Launch freeNexus."
...
LangString uninst_warning ${LANG_SERBIAN} "freeNexus is running. Please close the application before uninstalling."
