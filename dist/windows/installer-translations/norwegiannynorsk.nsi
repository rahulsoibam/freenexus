...
LangString inst_qbt_req ${LANG_NORWEGIANNYNORSK} "freeNexus (required)"
...
LangString inst_torrent ${LANG_NORWEGIANNYNORSK} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_NORWEGIANNYNORSK} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_NORWEGIANNYNORSK} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_NORWEGIANNYNORSK} "Launch freeNexus."
...
LangString uninst_warning ${LANG_NORWEGIANNYNORSK} "freeNexus is running. Please close the application before uninstalling."
