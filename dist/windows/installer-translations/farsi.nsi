...
LangString inst_qbt_req ${LANG_FARSI} "freeNexus (required)"
...
LangString inst_torrent ${LANG_FARSI} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_FARSI} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_FARSI} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_FARSI} "Launch freeNexus."
...
LangString uninst_warning ${LANG_FARSI} "freeNexus is running. Please close the application before uninstalling."
