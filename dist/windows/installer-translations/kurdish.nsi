...
LangString inst_qbt_req ${LANG_KURDISH} "freeNexus (required)"
...
LangString inst_torrent ${LANG_KURDISH} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_KURDISH} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_KURDISH} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_KURDISH} "Launch freeNexus."
...
LangString uninst_warning ${LANG_KURDISH} "freeNexus is running. Please close the application before uninstalling."
