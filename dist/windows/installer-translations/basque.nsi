...
LangString inst_qbt_req ${LANG_BASQUE} "freeNexus (beharrezkoa)"
...
LangString inst_torrent ${LANG_BASQUE} "Ireki .torrent agiriak freeNexus-rekin"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_BASQUE} "Ireki magnet loturak freeNexus-rekin"
...
LangString inst_warning ${LANG_BASQUE} "freeNexus ekinean dago. Mesedez itxi aplikazioa ezarri aurretik."
...
LangString launch_qbt ${LANG_BASQUE} "Abiarazi freeNexus."
...
LangString uninst_warning ${LANG_BASQUE} "freeNexus ekinean dago. Mesedez itxi aplikazioa kendu aurretik."
