...
LangString inst_qbt_req ${LANG_ICELANDIC} "freeNexus (required)"
...
LangString inst_torrent ${LANG_ICELANDIC} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_ICELANDIC} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_ICELANDIC} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_ICELANDIC} "Launch freeNexus."
...
LangString uninst_warning ${LANG_ICELANDIC} "freeNexus is running. Please close the application before uninstalling."
