...
LangString inst_qbt_req ${LANG_ESTONIAN} "freeNexus (required)"
...
LangString inst_torrent ${LANG_ESTONIAN} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_ESTONIAN} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_ESTONIAN} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_ESTONIAN} "Launch freeNexus."
...
LangString uninst_warning ${LANG_ESTONIAN} "freeNexus is running. Please close the application before uninstalling."
