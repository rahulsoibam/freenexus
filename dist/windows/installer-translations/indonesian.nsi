...
LangString inst_qbt_req ${LANG_INDONESIAN} "freeNexus (required)"
...
LangString inst_torrent ${LANG_INDONESIAN} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_INDONESIAN} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_INDONESIAN} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_INDONESIAN} "Launch freeNexus."
...
LangString uninst_warning ${LANG_INDONESIAN} "freeNexus is running. Please close the application before uninstalling."
