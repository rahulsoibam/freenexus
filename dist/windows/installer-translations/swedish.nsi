...
LangString inst_qbt_req ${LANG_SWEDISH} "freeNexus (required)"
...
LangString inst_torrent ${LANG_SWEDISH} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_SWEDISH} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_SWEDISH} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_SWEDISH} "Launch freeNexus."
...
LangString uninst_warning ${LANG_SWEDISH} "freeNexus is running. Please close the application before uninstalling."
