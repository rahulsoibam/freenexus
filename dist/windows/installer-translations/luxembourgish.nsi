...
LangString inst_qbt_req ${LANG_LUXEMBOURGISH} "freeNexus (required)"
...
LangString inst_torrent ${LANG_LUXEMBOURGISH} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_LUXEMBOURGISH} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_LUXEMBOURGISH} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_LUXEMBOURGISH} "Launch freeNexus."
...
LangString uninst_warning ${LANG_LUXEMBOURGISH} "freeNexus is running. Please close the application before uninstalling."
