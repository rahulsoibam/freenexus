...
LangString inst_qbt_req ${LANG_RUSSIAN} "freeNexus (обязательно)"
...
LangString inst_torrent ${LANG_RUSSIAN} "Открывать торрент-файлы с помощью freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_RUSSIAN} "Открывать magnet-ссылки с помощью freeNexus"
...
LangString inst_warning ${LANG_RUSSIAN} "freeNexus запущен. Пожалуйста, закройте freeNexus и перезапустите программу установки."
...
LangString launch_qbt ${LANG_RUSSIAN} "Запустить freeNexus."
...
LangString uninst_warning ${LANG_RUSSIAN} "freeNexus запущен. Пожалуйста, закройте freeNexus и перезапустите программу удаления."
