...
LangString inst_qbt_req ${LANG_ITALIAN} "freeNexus (necessario)"
...
LangString inst_torrent ${LANG_ITALIAN} "Apri file .torrent con freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_ITALIAN} "Apri collegamenti magnet con freeNexus"
...
LangString inst_warning ${LANG_ITALIAN} "freeNexus è in esecuzione. Chiudi l'applicazione prima dell'installazione."
...
LangString launch_qbt ${LANG_ITALIAN} "Esegui freeNexus."
...
LangString uninst_warning ${LANG_ITALIAN} "freeNexus è in esecuzione. Chiudi l'applicazione prima della disinstallazione."
