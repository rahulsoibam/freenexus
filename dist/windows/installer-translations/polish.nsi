...
LangString inst_qbt_req ${LANG_POLISH} "freeNexus (required)"
...
LangString inst_torrent ${LANG_POLISH} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_POLISH} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_POLISH} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_POLISH} "Launch freeNexus."
...
LangString uninst_warning ${LANG_POLISH} "freeNexus is running. Please close the application before uninstalling."
