...
LangString inst_qbt_req ${LANG_ESPERANTO} "freeNexus (required)"
...
LangString inst_torrent ${LANG_ESPERANTO} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_ESPERANTO} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_ESPERANTO} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_ESPERANTO} "Launch freeNexus."
...
LangString uninst_warning ${LANG_ESPERANTO} "freeNexus is running. Please close the application before uninstalling."
