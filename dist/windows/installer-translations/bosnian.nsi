...
LangString inst_qbt_req ${LANG_BOSNIAN} "freeNexus (required)"
...
LangString inst_torrent ${LANG_BOSNIAN} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_BOSNIAN} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_BOSNIAN} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_BOSNIAN} "Launch freeNexus."
...
LangString uninst_warning ${LANG_BOSNIAN} "freeNexus is running. Please close the application before uninstalling."
