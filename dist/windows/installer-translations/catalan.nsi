...
LangString inst_qbt_req ${LANG_CATALAN} "freeNexus (required)"
...
LangString inst_torrent ${LANG_CATALAN} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_CATALAN} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_CATALAN} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_CATALAN} "Launch freeNexus."
...
LangString uninst_warning ${LANG_CATALAN} "freeNexus is running. Please close the application before uninstalling."
