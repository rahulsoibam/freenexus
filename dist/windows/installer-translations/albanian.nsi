...
LangString inst_qbt_req ${LANG_ALBANIAN} "freeNexus (required)"
...
LangString inst_torrent ${LANG_ALBANIAN} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_ALBANIAN} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_ALBANIAN} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_ALBANIAN} "Launch freeNexus."
...
LangString uninst_warning ${LANG_ALBANIAN} "freeNexus is running. Please close the application before uninstalling."
