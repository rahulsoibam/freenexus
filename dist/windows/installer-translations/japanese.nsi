...
LangString inst_qbt_req ${LANG_JAPANESE} "freeNexus (必須)"
...
LangString inst_torrent ${LANG_JAPANESE} ".torrent ファイルは freeNexus で開く"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_JAPANESE} "マグネットリンクは freeNexus で開く"
...
LangString inst_warning ${LANG_JAPANESE} "freeNexus が起動されています。インストールの前にアプリケーションを終了してください。"
...
LangString launch_qbt ${LANG_JAPANESE} "freeNexus を起動する"
...
LangString uninst_warning ${LANG_JAPANESE} "freeNexus が起動されています。アンインストールの前にアプリケーションを終了してください。"
