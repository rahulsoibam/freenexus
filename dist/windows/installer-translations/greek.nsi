...
LangString inst_qbt_req ${LANG_GREEK} "freeNexus (απαιτείται)"
...
LangString inst_torrent ${LANG_GREEK} "Άνοιγμα των αρχείων .torrent με το freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_GREEK} "Άνοιγμα των μαγνητικών συνδέσμων με το freeNexus"
...
LangString inst_warning ${LANG_GREEK} "Το freeNexus βρίσκεται σε εκτέλεση. Παρακαλούμε κλείστε την εφαρμογή πριν την εγκατάσταση."
...
LangString launch_qbt ${LANG_GREEK} "Εκκίνηση του freeNexus."
...
LangString uninst_warning ${LANG_GREEK} "Το freeNexus βρίσκεται σε εκτέλεση. Παρακαλούμε κλείστε την εφαρμογή πριν την απεγκατάσταση."
