...
LangString inst_qbt_req ${LANG_FRENCH} "freeNexus (requis)"
...
LangString inst_torrent ${LANG_FRENCH} "Ouvrir fichiers .torrent avec freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_FRENCH} "Ouvrir liens magnet avec freeNexus"
...
LangString inst_warning ${LANG_FRENCH} "freeNexus est en cours d'exécution. Veuillez fermer l'application avant l'installation."
...
LangString launch_qbt ${LANG_FRENCH} "Lancer freeNexus."
...
LangString uninst_warning ${LANG_FRENCH} "freeNexus est en cours d'exécution. Veuillez fermer l'application avant la désinstallation."
