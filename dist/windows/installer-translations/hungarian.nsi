...
LangString inst_qbt_req ${LANG_HUNGARIAN} "freeNexus (required)"
...
LangString inst_torrent ${LANG_HUNGARIAN} "Open .torrent files with freeNexus"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with freeNexus"
LangString inst_magnet ${LANG_HUNGARIAN} "Open magnet links with freeNexus"
...
LangString inst_warning ${LANG_HUNGARIAN} "freeNexus is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_HUNGARIAN} "Launch freeNexus."
...
LangString uninst_warning ${LANG_HUNGARIAN} "freeNexus is running. Please close the application before uninstalling."
